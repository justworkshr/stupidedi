...
stack  = Stupidedi::Builder::IdentifierStack.new(Time.now.to_i % 10 ** 9)
b      = Stupidedi::Builder::BuilderDsl.build(config, false)

b.ISA "00", "", "00", "", "ZZ", "SUBMITTER ID", "ZZ", "RECEIVER ID", "990531", "1230", "^", "00501", stack.isa, "1", "T", ":"
b.GS  "HC", "SENDER ID", "RECEIVER ID", "19990531", "1230", stack.gs, "X", "005010X222"
b.ST  "837", stack.st, b.default
...
b.HL  stack.hl, stack.parent, "20", "1"
...
b.N4  "MIAMI", "FL", "33111"
b.HL  stack.hl, stack.parent, "22", "0"
b.SBR "S", "18", "", "", "12", "", "", "", "MB"
#.PAT "1", "2", "3", "4"
...
b.SE  stack.count(b), stack.pop
b.GE  stack.count, stack.pop
b.IEA stack.count, stack.pop
